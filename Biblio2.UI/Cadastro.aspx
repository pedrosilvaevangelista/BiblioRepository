    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="formulario">
                ...
                <div class="form-group">
                    <asp:TextBox ID="txtSenhaUsuario" MaxLength="6" placeholder="Senha" runat="server" TextMode="Password"></asp:TextBox>
                    <asp:Label ID="lblSenhaUsuario" runat="server" Text="" CssClass="error-message"></asp:Label>
                </div>
                <div class="form-group">
                    <asp:TextBox ID="txtConfirmarSenha" MaxLength="6" placeholder="Confirme a Senha" runat="server" TextMode="Password"></asp:TextBox>
